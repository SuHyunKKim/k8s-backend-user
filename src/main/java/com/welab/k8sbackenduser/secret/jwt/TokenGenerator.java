package com.welab.k8sbackenduser.secret.jwt;

import com.welab.k8sbackenduser.secret.jwt.dto.TokenDto;
import com.welab.k8sbackenduser.secret.jwt.props.JwtConfigProperties;
    ...
    private SecretKey getSecretKey() {
        if (secretKey == null) {
            synchronized (this) {
                if (secretKey == null) {
                    secretKey = Keys
                            .hmacShaKeyFor(Decoders.BASE64.decode(configProperties.getSecretKey()));
                }
            }
        }
        return secretKey;
